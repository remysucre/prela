# TPC-H, all 22 queries, in idiomatic Prela — the baseline implementations.
# Hand-tuned rewrites of a subset live in `tpch_queries_optimized.jl`, which
# overlays this file.
#
# Run via `include("TPCH.jl"); include("tpch_queries_idiomatic.jl")`.
# Each query is checked against an oracle string generated by DuckDB on the
# same SF=1 data (short oracles inline; long ones from ../oracles/tpch via
# `_oracle`). Float64 values formatted as %.2f to match DuckDB's FixedDecimal
# column scales (sufficient for tie-the-knot tolerance).
...
const _ORACLE_Q9 = let raw = _oracle(9)
...
# ============================================================================
# Q18 — large-volume customers (orders with sum(quantity) > 300)
# ============================================================================

const _ORACLE_Q18 = _oracle(18)

function _q18()
    # Subquery: sum(l_quantity) per orderkey, over ALL lineitems
    sum_qty_per_order = (order ← quantity) ▷ (+, 0.0)
...
# ============================================================================
# Q22 — global sales opportunity (phone prefixes, NOT EXISTS orders)
# ============================================================================

const _ORACLE_Q22 = _oracle(22)
