// PULL-PROTOCOL PORT of src/queries/t3.rs — identical plans, pull sinks.
// queries: 7a-c, 8a-d, 9a-d, 10a-c (queries.jl lines 591-753)
use crate::data::Data;
use crate::engine::*;
use crate::pull::ProbeIter;
use super::helpers::*;
use super::sets::*;
...
fn bio_filter_7c<'d>(d: &'d Data) -> impl Query<D = usize> + Probe + ProbeIter + 'd {
    (&d.personinfo_type).o(&d.infotype_info).eq("mini biography")
