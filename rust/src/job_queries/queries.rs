...
use crate::engine::*;
use crate::job_queries::helpers::{Row, Output};
...
fn entry<T: 'static>(name: &'static str, oracle: &'static str, q: impl Fn() -> T + 'static) -> Entry<T> {
    (name, oracle, Box::new(move |_| q()))
}

pub fn entries<O: Output>(db: &'static Job) -> Vec<Entry<O::Value>> {
    ...
    vec![
        entry("1a", "(A Warner Bros.-First National Picture) (presents) || A Clockwork Orange || 1934", move || O::finish("1a", q1a())),
        entry("1b", "(Set Decoration Rentals) (uncredited) || Disaster Movie || 2008", move || O::finish("1b", q1b())),
        entry("1c", "(co-production) || Intouchables || 2011", move || O::finish("1c", q1c())),
        entry("1d", "(Set Decoration Rentals) (uncredited) || Disaster Movie || 2004", move || O::finish("1d", q1d())),
        entry("2a", "'Doc'", move || O::finish("2a", q2a())),
        entry("2b", "'Doc'", move || O::finish("2b", q2b())),
        entry("2c", "(empty)", move || O::finish("2c", q2c())),
        entry("2d", "& Teller", move || O::finish("2d", q2d())),
        entry("3a", "2 Days in New York", move || O::finish("3a", q3a())),
        entry("3b", "300: Rise of an Empire", move || O::finish("3b", q3b())),
        entry("3c", "& Teller 2", move || O::finish("3c", q3c())),
        entry("4a", "5.1 || & Teller 2", move || O::finish("4a", q4a())),
        entry("4b", "9.1 || Batman: Arkham City", move || O::finish("4b", q4b())),
        entry("4c", "2.1 || & Teller 2", move || O::finish("4c", q4c())),
        entry("5a", "(empty)", move || O::finish("5a", q5a())),
        entry("5b", "(empty)", move || O::finish("5b", q5b())),
        entry("5c", "11,830,420", move || O::finish("5c", q5c())),
        entry("6a", "marvel-cinematic-universe || Iron Man 3 || Downey Jr., Robert", move || O::finish("6a", q6a())),
        entry("6b", "based-on-comic || The Avengers 2 || Downey Jr., Robert", move || O::finish("6b", q6b())),
        entry("6c", "marvel-cinematic-universe || The Avengers 2 || Downey Jr., Robert", move || O::finish("6c", q6c())),
        entry("6d", "based-on-comic || 2008 MTV Movie Awards || Downey Jr., Robert", move || O::finish("6d", q6d())),
        entry("6e", "marvel-cinematic-universe || Iron Man 3 || Downey Jr., Robert", move || O::finish("6e", q6e())),
        entry("6f", "based-on-comic || & Teller 2 || \"Steff\", Stefanie Oxmann Mcgaha", move || O::finish("6f", q6f())),
        entry("7a", "Antonioni, Michelangelo || Dressed to Kill", move || O::finish("7a", q7a())),
        entry("7b", "De Palma, Brian || Dressed to Kill", move || O::finish("7b", q7b())),
        entry("7c",
              ...
              move || O::finish("7c", q7c())),
        entry("8a", "Chambers, Linda || .hack//Quantum", move || O::finish("8a", q8a())),
        entry("8b", "Chambers, Linda || Dragon Ball Z: Shin Budokai", move || O::finish("8b", q8b())),
        entry("8c", "\"A.J.\" || #1 Cheerleader Camp", move || O::finish("8c", q8c())),
        entry("8d", "\"Jenny from the Block\" || #1 Cheerleader Camp", move || O::finish("8d", q8d())),
        entry("9a", "AJ || Airport Announcer || Blue Harvest", move || O::finish("9a", q9a())),
        entry("9b", "AJ || Bassett, Angela || Airport Announcer || Blue Harvest", move || O::finish("9b", q9b())),
        entry("9c", "'Annette' || Alborg, Ana Esther || 2nd Balladeer || (1975-01-20)", move || O::finish("9c", q9c())),
        entry("9d", "!!!, Toy || Aaron, Caroline || \"Cockamamie's\" Salesgirl || $15,000.00 Error", move || O::finish("9d", q9d())),
        entry("10a", "Actor || 12 Rounds", move || O::finish("10a", q10a())),
        entry("10b", "(empty)", move || O::finish("10b", q10b())),
        entry("10c", "Himself || Evil Eyes: Behind the Scenes", move || O::finish("10c", q10c())),
        entry("11a", "Churchill Films || followed by || Batman Beyond", move || O::finish("11a", q11a())),
        entry("11b", "Filmlance International AB || follows || The Money Man", move || O::finish("11b", q11b())),
        entry("11c", "20th Century Fox Home Entertainment || (1997-2002) (worldwide) (all media) || 24", move || O::finish("11c", q11c())),
        entry("11d", "13th Street || (1954) (UK) (TV) || ...denn sie wissen nicht, was sie tun", move || O::finish("11d", q11d())),
        entry("12a", "10th Grade Reunion Films || 8.1 || 3:20", move || O::finish("12a", q12a())),
        entry("12b", "$10,000 || Birdemic: Shock and Terror", move || O::finish("12b", q12b())),
        entry("12c", "\"Oh That Gus!\" || 7.1 || $1.11", move || O::finish("12c", q12c())),
        entry("13a", "Afghanistan:24 June 2012 || 1.0 || &Me", move || O::finish("13a", q13a())),
        entry("13b", "5 Time Champion || 501audio || 1.8", move || O::finish("13b", q13b())),
        entry("13c", "Champion || DL Sites || 1.8", move || O::finish("13c", q13c())),
        entry("13d", "\"O\" Films || 1.0 || #54 Meets #47", move || O::finish("13d", q13d())),
        entry("14a", "1.0 || $lowdown", move || O::finish("14a", q14a())),
        entry("14b", "6.4 || Of Dolls and Murder", move || O::finish("14b", q14b())),
        entry("14c", "1.0 || $lowdown", move || O::finish("14c", q14c())),
        entry("15a", "USA:1 June 2007 || Battlestar Galactica: The Resistance", move || O::finish("15a", q15a())),
        entry("15b", "USA:27 April 2007 || RoboCop vs Terminator", move || O::finish("15b", q15b())),
        entry("15c", "USA:1 April 2003 || 24: Day Six - Debrief", move || O::finish("15c", q15c())),
        entry("15d", "(Not So) Instant Photo || 06/05", move || O::finish("15d", q15d())),
        entry("16a", "Adams, Stan || Carol Burnett vs. Anthony Perkins", move || O::finish("16a", q16a())),
        entry("16b", "!!!, Toy || & Teller", move || O::finish("16b", q16b())),
        entry("16c", "\"Brooklyn\" Tony Danza || (#1.5)", move || O::finish("16c", q16c())),
        entry("16d", "\"Brooklyn\" Tony Danza || (#1.5)", move || O::finish("16d", q16d())),
        entry("17a", "B, Khaz", move || O::finish("17a", q17a())),
        entry("17b", "Z'Dar, Robert", move || O::finish("17b", q17b())),
        entry("17c", "X'Volaitis, John", move || O::finish("17c", q17c())),
        entry("17d", "Abrahamsson, Bertil", move || O::finish("17d", q17d())),
        entry("17e", "$hort, Too", move || O::finish("17e", q17e())),
        entry("17f", "'El Galgo PornoStar', Blanquito", move || O::finish("17f", q17f())),
        entry("18a", "$1,000 || 10 || 40 Days and 40 Nights", move || O::finish("18a", q18a())),
        entry("18b", "Horror || 8.1 || Agorable", move || O::finish("18b", q18b())),
        entry("18c", "Action || 10 || #PostModem", move || O::finish("18c", q18c())),
        entry("19a", "Angeline, Moriah || Blue Harvest", move || O::finish("19a", q19a())),
        entry("19b", "Jolie, Angelina || Kung Fu Panda", move || O::finish("19b", q19b())),
        entry("19c", "Alborg, Ana Esther || .hack//Akusei heni vol. 2", move || O::finish("19c", q19c())),
        entry("19d", "Aaron, Caroline || $9.99", move || O::finish("19d", q19d())),
        entry("20a", "Disaster Movie", move || O::finish("20a", q20a())),
        entry("20b", "Iron Man", move || O::finish("20b", q20b())),
        entry("20c", "Abell, Alistair || ...And Then I...", move || O::finish("20c", q20c())),
        entry("21a", "Det Danske Filminstitut || followed by || Der Serienkiller - Klinge des Todes", move || O::finish("21a", q21a())),
        entry("21b", "Filmlance International AB || followed by || Hämndens pris", move || O::finish("21b", q21b())),
        entry("21c", "Churchill Films || followed by || Batman Beyond", move || O::finish("21c", q21c())),
        entry("22a", "(empty)", move || O::finish("22a", q22a())),
        entry("22b", "(empty)", move || O::finish("22b", q22b())),
        entry("22c", "(empty)", move || O::finish("22c", q22c())),
        entry("22d", "(#1.1) || 2.0 || 13 Productions", move || O::finish("22d", q22d())),
        entry("23a", "movie || The Analysts", move || O::finish("23a", q23a())),
        entry("23b", "movie || The Big Mope", move || O::finish("23b", q23b())),
        entry("23c", "movie || Dirt Merchant", move || O::finish("23c", q23c())),
        entry("24a", "Additional Voices || Baker, Andrea || Baiohazâdo 6", move || O::finish("24a", q24a())),
        entry("24b", "Tigress || Jolie, Angelina || Kung Fu Panda 2", move || O::finish("24b", q24b())),
        entry("25a", "Horror || 10 || -- And Now the Screaming Starts! || Abdallah, Damon", move || O::finish("25a", q25a())),
        entry("25b", "Horror || 138 || Vampire Boys || Campbell, Jeremiah", move || O::finish("25b", q25b())),
        entry("25c", "Action || 10 || $ || Aakeson, Kim Fupz", move || O::finish("25c", q25c())),
        entry("26a", "'Agua' Man || Acereda, Hermie || 7.1 || 3:10 to Yuma", move || O::finish("26a", q26a())),
        entry("26b", "Bank Manager || 8.2 || Inception", move || O::finish("26b", q26b())),
        entry("26c", "'Agua' Man || 1.9 || 12 Rounds", move || O::finish("26c", q26c())),
        entry("27a", "Det Danske Filminstitut || followed by || Spår i mörker", move || O::finish("27a", q27a())),
        entry("27b", "Filmlance International AB || followed by || Vita nätter", move || O::finish("27b", q27b())),
        entry("27c", "Det Danske Filminstitut || followed by || Spår i mörker", move || O::finish("27c", q27c())),
        entry("28a", "01 Distribuzione || 2.9 || (#1.1)", move || O::finish("28a", q28a())),
        entry("28b", "20th Century Fox || 6.6 || (#1.1)", move || O::finish("28b", q28b())),
        entry("28c", "01 Distribuzione || 1.9 || (#1.1)", move || O::finish("28c", q28c())),
        entry("29a", "Queen || Andrews, Julie || Shrek 2", move || O::finish("29a", q29a())),
        entry("29b", "Queen || Andrews, Julie || Shrek 2", move || O::finish("29b", q29b())),
        entry("29c", "Lola || Andrews, Julie || Hoodwinked!", move || O::finish("29c", q29c())),
        entry("30a", "Horror || 100356 || 16 Blocks || Abrams, J.J.", move || O::finish("30a", q30a())),
        entry("30b", "Horror || 194782 || Freddy vs. Jason || Shannon, Damian", move || O::finish("30b", q30b())),
        entry("30c", "Action || 100356 || $ || Abernathy, Lewis", move || O::finish("30c", q30c())),
        entry("31a", "Horror || 1040 || 2001 Maniacs || Agnew, Jim", move || O::finish("31a", q31a())),
        entry("31b", "Horror || 129755 || Saw || Bousman, Darren Lynn", move || O::finish("31b", q31b())),
        entry("31c", "Action || 1008 || 11:14 || Abraham, Brad", move || O::finish("31c", q31c())),
        entry("32a", "(empty)", move || O::finish("32a", q32a())),
        entry("32b", "alternate language version of || 'Angel': Season 2 Overview || 12 oz. Mouse", move || O::finish("32b", q32b())),
        entry("33a", "495 Productions || 3.3 || A Double Shot at Love || 495 Productions || 2.7 || A Shot at Love with Tila Tequila", move || O::finish("33a", q33a())),
        entry("33b", "MTV Netherlands || 3.3 || A Double Shot at Love || 495 Productions || 2.7 || A Shot at Love with Tila Tequila", move || O::finish("33b", q33b())),
        entry("33c", "2BE || 1.3 || A Double Shot at Love || 495 Productions || 1.0 || A Double Shot at Love", move || O::finish("33c", q33c())),
        entry("6a/method", "marvel-cinematic-universe || Iron Man 3 || Downey Jr., Robert", move || O::finish("6a/method", q6a_methods(db))),
    ]
}
